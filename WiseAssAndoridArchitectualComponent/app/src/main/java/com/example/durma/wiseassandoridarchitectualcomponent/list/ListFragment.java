package com.example.durma.wiseassandoridarchitectualcomponent.list;
...
import com.example.durma.wiseassandoridarchitectualcomponent.create.CreateActivity;
...
import com.example.durma.wiseassandoridarchitectualcomponent.detail.DetailActivity;
import com.example.durma.wiseassandoridarchitectualcomponent.viewmodel.ListItemCollectionViewModel;
...
public class ListFragment extends LifecycleFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        listItemCollectionViewModel.getListItems()
                .observe(this, new Observer<List<ListItem>>() {
            @Override
